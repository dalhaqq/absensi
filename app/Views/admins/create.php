            ...
            <div class="flex justify-between mb-6">
                <div>
                    <div class="flex items-center mb-1">
                        <div class="text-2xl text-mygreen font-semibold">Create Admin</div>
                    </div>
                </div>
                <div>
                ...
                <form action="<?= route_to('admins.store') ?>" method="post">
                    <div class="gap-6 flex justify-center mb-6">
                        <div class="input-group">
                            <label for="employee_id" class="label">Name</label>
                        ...
                        <div class="input-group">
                            <label for="is_super" class="label">Access</label>
                    ...
                    <div>
                        <button type="submit" class="btn text-white bg-myorange">Create</button>
                    </div>
                </form>
            </div>
        </div>
